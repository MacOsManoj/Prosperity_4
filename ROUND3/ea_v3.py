...
BASE_EDGE = 2             # ea_v3: wider spread
...
REGRET_THRESHOLD = 750    # ea_v3: tighter delta cap
...
SMILE_GAMMA      = 0.999
SMILE_WARMUP_N   = 500     # ea_v3: start quoting sooner
...
class VoucherTrader(ProductTrader):
    ...
    def get_orders(self):
        ...
        # ea_v3: Taker leg — aggressively cross if clearly mispriced (>= BASE_EDGE edge)
