...
BASE_EDGE = 2             # ea_v2: wider spread — earn more per fill
...
REGRET_THRESHOLD = 750    # ea_v2: tighter delta cap (was 1500)
...
SMILE_GAMMA      = 0.999
SMILE_WARMUP_N   = 500     # ea_v2: start quoting sooner (was 2000)
